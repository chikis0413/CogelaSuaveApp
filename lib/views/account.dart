...
import 'package:cogela_suave/views/activity_entry.dart';
import 'package:cogela_suave/views/emotion_entry.dart';
import 'package:cogela_suave/views/calendar_page.dart';
import 'package:cogela_suave/views/account_page.dart' as user_profile;
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => user_profile.AccountPage(userId: _userId),
                ),
              );
            },
          ),
